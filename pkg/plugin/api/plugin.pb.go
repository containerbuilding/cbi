...
type BuildRequest struct {
	...
	BuildJobJson string `protobuf:"bytes,1,opt,name=build_job_json,json=buildJobJson,proto3" json:"build_job_json,omitempty"`
}

func (m *BuildRequest) Reset()                    { *m = BuildRequest{} }
func (m *BuildRequest) String() string            { return proto.CompactTextString(m) }
func (*BuildRequest) ProtoMessage()               {}
func (*BuildRequest) Descriptor() ([]byte, []int) { return fileDescriptorPlugin, []int{2} }

func (m *BuildRequest) GetBuildJobJson() string {
	if m != nil {
...
func (*BuildResponse) Descriptor() ([]byte, []int) { return fileDescriptorPlugin, []int{3} }

func (m *BuildResponse) GetJobName() string {
	if m != nil {
		return m.JobName
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*BuildRequest)(nil), "cbi.plugin.v1.BuildRequest")
	proto.RegisterType((*BuildResponse)(nil), "cbi.plugin.v1.BuildResponse")
}
...
func (c *pluginClient) Build(ctx context.Context, in *BuildRequest, opts ...grpc.CallOption) (*BuildResponse, error) {
	...
	err := grpc.Invoke(ctx, "/cbi.plugin.v1.Plugin/Build", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Plugin_Build_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cbi.plugin.v1.Plugin/Build",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *BuildResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.JobName) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintPlugin(dAtA, i, uint64(len(m.JobName)))
...
func (m *BuildRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.BuildJobJson = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPlugin(dAtA[iNdEx:])
...
var fileDescriptorPlugin = []byte{
	...
	,
}
