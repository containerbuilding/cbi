...
import (
	...
	"github.com/containerbuilding/cbi/cmd/cbid/backend"
...
func NewController(
	...
	cbiInformerFactory informers.SharedInformerFactory) *Controller {
...
func (c *Controller) syncHandler(key string) error {
	...
	job, err := c.jobsLister.Jobs(buildJob.Namespace).Get(jn)
